...
<body class="bg-gray-100">
    <div class="max-w-3xl mx-auto mt-10 p-6 bg-white rounded-lg shadow-md">
        <div class="flex items-start mb-6 flex-col">
            ...
            <h1 class="text-2xl font-bold ml-4">Edit Intern</h1>
        </div>
        <form action="/dashboard/edit" method="POST" enctype="multipart/form-data">
            ...
            <div class="mb-4">
                ...
                <input type="text" id="family_name" name="family_name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= $nom ?>" required>
            </div>
            <div class="mb-4">
                <label for="first_name" class="block text-gray-700 font-medium mb-2">First Name</label>
                <input type="text" id="first_name" name="first_name" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= $prenom ?>" required>
            </div>
            <div class="mb-4">
                <label for="birthday" class="block text-gray-700 font-medium mb-2">Birthday</label>
                <input type="date" id="birthday" name="birthday" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" value="<?= $dateNaissance ?>" required>
            </div>
            <div class="mb-4">
                ...
                <select id="field" name="field" class="w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    ...
                    <?php
                        ...
                        foreach($filieres as $filiere){
                            $filiere -> idFiliere == $filiereSelected ? $x = 'selected' : $x = ''; 
                            echo "<option value='{$filiere -> idFiliere}' $x>{$filiere -> intitue}</option>";
                        }
                    ?>
                </select>
            </div>
